import type { NodeProcessor, ProcessorContext, PropertyNodeElement } from '@/src/canvas/workflow-executor';
import { safeStringify } from '@/src/canvas/workflow-executor';

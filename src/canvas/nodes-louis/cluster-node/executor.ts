...
import { buildClustersFromElements, type ClusterConfig } from '@/src/canvas/nodes-louis/cluster-node/utils';
// NOTE: findUpstreamIfcNode was removed - this node is deprecated
// import { findUpstreamIfcNode } from '@/src/canvas/workflow-executor';
  ...
  async process(node: any, inputValues: any, context: ProcessorContext): Promise<any> {
    ...
    try {
      ...
      if (clusterResult) {
        ...
        // NOTE: findUpstreamIfcNode was removed - deprecated node
        // else {
